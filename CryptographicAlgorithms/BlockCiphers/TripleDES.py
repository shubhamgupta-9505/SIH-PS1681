...
def encrypt_DES3 (plaintext: bytes, mode: int):
    '''
    Input parameter "plaintext" must be in Bytes format, with bytes divisible by DES3 block size (128 bits)
    '''
...
if __name__ == "__main__":
    print(encrypt_DES3(b"This is Sixteen.", 1))
    print(encrypt_DES3(b"This is Sixteen.", 2))
    print(encrypt_DES3(b"This is Sixteen.", 3))
    print(encrypt_DES3(b"This is Sixteen.", 4))
    print(encrypt_DES3(b"This is Sixteen.", 5))
